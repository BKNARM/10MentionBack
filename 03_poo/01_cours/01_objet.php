    ...
    <div class="container">
        <div class="row">
            <div class="col-12">
                ...
                <p>Par exemple, les dates. Les dates en PHP sont complexes, les dates soient en string et c'est chiant, soit en nombres et c'est tout aussi chiant, il va falloir convertir et passer d'un format à l'autre.</p>
                ...
                <p class="alert alert-info">
                    ...
                    <strong>$date1 et $date2</strong> sont des objets ou bien des instances de cette classe
                </p><!-- la classe va être la définition, et l'objet va être une indtance de cette définition, un objet.  -->
            </div>
            <div class="col-12">
            ...
            <div class="col-12">
                ...
                <p>Sur nos différents objets, nous allons aussi pouvoir avoir des méthodes. Les méthodes sont en fait des fonctions, elle auront donc la même nomenclature : <code>nomMethode()</code>. La différence est qu'elles s'appliquent directement sur un objet, une instance <code>$date->addDays()</code>.</p>
            </div>
        </div>
    </div>
