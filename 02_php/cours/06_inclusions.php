<?php
$title = "Cours PHP - Importation de fichier";
$titre = "Importations de fichiers en PHP avec 'require()' et 'include()'";
$monparagraphe = "Lorsque l'on crée un fichier que l'on veut inclure, la convention dit que l'on ajoute '<span>.inc</span>' avant '<span>.php</span>' et on crée ces fichier dans un dossier nommé '<span>inc.</span>' Il n'y a pas d'influence sur la lecture du fichier, c'est une convention et une organisation.
" ;
