<?php
$title = "Cours PHP - Les Tableaux en PHP";
$titre = "Les Tableaux en PHP";
$monparagraphe = "Les boucles (qu'on appelle aussi des structures itératives) sont un moyen de faire répéter plusieurs fois un même morceau de code. Une boucle est donc une répétition, comme on a pu le voir en JavaScript
";
...
?>
    ...
    <div class="row">
        ...
        <div class="col-sm-12">
            ...
            <ul>
                <li>La boucle "<span>foreach()</span>" est un moyen simple de passer en revue un tableau de façon automatique. Cette boucle ne fonction que sur les tableaux et les objets.</li>
