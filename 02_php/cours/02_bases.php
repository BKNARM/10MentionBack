<?php
$title = "Cours PHP - Les Bases du php";
...
?>
        ...
        <div class="row border p-5 mt-5">
            ...
            <div class="col-sm-12 col-md-6">
                ...
                <?php
                    // pour pouvoir utiliser les commentaires en php il faut le faire dans la balise php
            ...
            <div class="col-sm-12">
                ...
                <ul>
                    ...
                    <li>Les instructions <span>var_dump()</span> et <span>print_r</span> : permettent d'afficher du contenu mais on s'en servira principalement pour débugger. Ces deux fonctions permettent d'analyser dans le navigateur le contenu d'une variable par exemple (nous verrons l'utilisation plus tard)</li>
                </ul>
            </div>
            <div class="col-sm-12">
            ...
            <div class="col-sm-12">
                ...
                <ul>
                    ...
                    <li>Les caractères qui suivent peuvent être les mêmes avec en plus l'ensemble [0_9] <span>(jamais au début)</span></li>
                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-sm-12 col-mmd-4 me-5 alert alert-success">
                        <ul>
                    ...
                    <div class="col-sm-12 col-mmd-4 me-5 alert alert-danger">
                        <ul>
                            <li><span>$*mavar</span></li>
            ...
            <div class="col-sm-12">
                ...
                <p>Affeccter une variable consiste à lui donner une valeur : lorsque vous déclarer une variable vous ne lui donnez pas de type, c'est la valeur que vous lui affectez qui va déterminer son type</p>
                <ul>
